...
export GIT_REPO_URL="https://github.com/emcduffie111/mediascrubbing-floodhealth.git"
export COOKBOOK_NAME="SemanticBridge_Burst_Integrated_Floods"
export COOKBOOK_CONDA_ENV="mediascrubbing"
IS_GPU_JOB=false
